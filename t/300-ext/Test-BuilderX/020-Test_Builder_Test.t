...
is( mop::class_of( $pass_test ), Test::BuilderX::Test::Pass, '... we got a Test::BuilderX::Test::Pass instance');
...
is( mop::class_of( $fail_test ), Test::BuilderX::Test::Fail, '... we got a Test::BuilderX::Test::Fail instance');
...
is( mop::class_of( $todo_test ), Test::BuilderX::Test::TODO, '... we got a Test::BuilderX::Test::TODO instance');
...
is( mop::class_of( $skip_test ), Test::BuilderX::Test::Skip, '... we got a Test::BuilderX::Test::Skip instance');
