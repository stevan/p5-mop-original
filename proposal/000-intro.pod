...
The following is a proposal for the introduction of a completely
...
backwards and forwards compatability as well as not burden
ourselves with the choices of the past. Allow me expand on
this somewhat.

How this helps backwards compatability is fairly obvious since
the system will be completely new and just simply live beside
the old one. But it also helps forward compatability, by which
I mean the ability for old-style Perl OO and new-style Perl OO
to interoperate. There are billions of lines of Perl code on
...
it should not be removed or deprecated. However, this new system
