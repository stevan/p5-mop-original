...
Please take all rants contained herein with a large camel-size chunck
of salt.
...
responsiblity upon the user to do any number of different
ways. This is, IMO, a case where TIMTOWTDI has been a
hinderence rather then a help.
