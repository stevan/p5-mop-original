...
The syntax of a C<class> definition has four variants, I
...
quoted strings. As will be described in later documents,
...
This last variant is actually fairly obvious by now, it is
