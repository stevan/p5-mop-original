...
getting a truely Perlish level of flexibility and extensibility,
...
within a set of parantheses which, when evaluated, should
...
set of key-value pairs otherwise known in Perl as a hash.
